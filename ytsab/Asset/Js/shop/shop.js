...
const slideData = [{
  index: 0,
  a: 'View',
  src: 'https://github.com/piron-ph/piron-ph.github.io/blob/main/ytsab/images/Shop/RTX2060/down.png?raw=true'
}, {
  index: 1,
  a: 'View',
  src: 'https://github.com/piron-ph/piron-ph.github.io/blob/main/ytsab/images/Shop/RTX2070/down.png?raw=true'
}, {
  index: 2,
  a: 'View',
